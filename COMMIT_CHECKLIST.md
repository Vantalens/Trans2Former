...
- [ ] 新增重格式或可选能力时，已按核心本地模块处理，并提供资源预算和失败降级说明。
- [ ] 未新增插件安装、插件下载、插件更新或 `.t2f-plugin.json` 分发路径。
...
- 默认包遵守 [docs/RESOURCE_BUDGET.md](docs/RESOURCE_BUDGET.md)，重格式和可选增强必须通过核心本地模块按需加载。
- 成本、资源和核心模块治理遵守 [docs/development-standards/07_COST_AND_RESOURCE_GOVERNANCE.md](docs/development-standards/07_COST_AND_RESOURCE_GOVERNANCE.md)。
...
- [ ] 若涉及核心重能力方向，已同步更新 `docs/development-standards/`、资源预算和格式路线。
